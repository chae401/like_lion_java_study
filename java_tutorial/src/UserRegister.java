        ...
        while(true){
            ...
            while(true){
                ...
                if(pw.equals(pw_confirm)){
                    ...
                    System.out.println("패스워드 다시 입력 부탁");
                    System.out.println("===================");
                }
            }
            ...
            while(true){
                ...
                if(birth_date.length()==6){
                    ...
                    System.out.println("===================");
                    System.out.println("생년월일 자릿수가 올바르지 않습니다. 다시 입력");
                    System.out.println("===================");
                }
            }
            ...
            System.out.println("=================================");
            System.out.println(user.get("name")+"님, 가입 환영해옹");
            System.out.println("ID는 "+user.get("userName")+"입니당");
            System.out.println("=================================");
